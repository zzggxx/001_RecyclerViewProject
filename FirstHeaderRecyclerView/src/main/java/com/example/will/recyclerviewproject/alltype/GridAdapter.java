...
public class GridAdapter extends RecyclerView.Adapter<GridAdapter.ListHolder> {
    ...
    String names[] = {
            "浏览器", "输入法", "健康", "效率", "教育", "理财", "阅读", "个性化", "购物",
            "资讯", "生活", "工具", "出行", "通讯", "拍照", "社交", "影音", "安全",
            "休闲", "棋牌", "益智", "射击", "体育", "儿童", "网游", "角色", "策略"};
    Context context;
    boolean flag;
    ...
    public ListHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (flag) {
            ...
            view = LayoutInflater.from(context).inflate(R.layout.grid_item_h, parent, false);
        }
