...
import com.example.secondheaderrecyclerview.base.listview.adapter.CommonAdapter;
import com.example.secondheaderrecyclerview.base.listview.viewholder.ViewHolder;
import com.example.secondheaderrecyclerview.ui.message.MultiItemListViewActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<String> mDatas =
            new ArrayList<>(Arrays.asList("MultiItem ListView", "RecyclerView", "MultiItem RecyclerView"));
